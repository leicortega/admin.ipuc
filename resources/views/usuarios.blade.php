...
<div class="grid grid-cols-12 gap-6 mt-5">
    <div class="intro-y col-span-12 flex flex-wrap sm:flex-no-wrap items-center mt-2">
        <a href="javascript:;" data-toggle="modal" data-target="#agregar_usuario_modal" class="button text-white bg-theme-1 shadow-md mr-2">Agregar Usuario</a>
        ...
        <table class="table table-report -mt-2">
            <thead>
                <tr>
                    ...
                    <th class="text-center whitespace-no-wrap">CORREO</th>
            ...
            <tbody>
                @foreach ($usuarios as $item)
                    <tr class="intro-x">
                        ...
                        <td>
                            <span class="font-medium whitespace-no-wrap">{{ $item->name }}</span> 
                        </td>
    ...
    {{-- MODAL ADD CULTO --}}
    <div class="modal" id="agregar_usuario_modal">
            ...
            <form action="/usuarios/create" method="post">
                ...
                <div class="p-5 grid grid-cols-12 gap-4 row-gap-3">
                    <div class="col-span-12 sm:col-span-12">
                        <label>Nombre</label>
                        <input type="text" class="input w-full border mt-2 flex-1" name="name" placeholder="Escriba el nombre" required>
                    </div>
                    <div class="col-span-12 sm:col-span-6">
                        <label>Identificacion</label>
                        <input type="number" class="input w-full border mt-2 flex-1" name="identificacion" placeholder="Escriba la identificacion" required>
                    </div>
                    <div class="col-span-12 sm:col-span-6">
                        <label>Contraseña</label>
                        <input type="password" class="input w-full border mt-2 flex-1" placeholder="Escriba la contraseña" name="password" required>
                    </div>
                    <div class="col-span-12 sm:col-span-12">
                        <label>Correo</label>
                        <input type="text" class="input w-full border mt-2 flex-1" name="email" placeholder="Escriba el Correo" required>
                    </div>
                </div>
